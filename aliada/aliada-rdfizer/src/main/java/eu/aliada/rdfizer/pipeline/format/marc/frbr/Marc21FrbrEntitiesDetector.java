...
public class Marc21FrbrEntitiesDetector implements Processor {
	...
	public void process(final Exchange exchange) throws Exception {
		...
		log.debug("processing: " + entitiesDocument.getManifestationID());
//		log.debug(entitiesDocument.getManifestationID() + " - persons: " + function.printAuthors(entitiesDocument));
